...
export const createComentario = async (comentario: Partial<Comentario>): Promise<Comentario> => {
  const response = await apiService.post<Comentario>('/comentarios', comentario);
  return response.data;
};

export const updateComentario = async (id: number, comentario: Partial<Comentario>): Promise<Comentario> => {
  const response = await apiService.put<Comentario>(`/comentarios/${id}`, comentario);
  return response.data;
};
...
export const createRespuesta = async (respuesta: Partial<Respuesta>): Promise<Respuesta> => {
  const response = await apiService.post<Respuesta>('/respuestas', respuesta);
  return response.data;
};

export const updateRespuesta = async (id: number, respuesta: Partial<Respuesta>): Promise<Respuesta> => {
  const response = await apiService.put<Respuesta>(`/respuestas/${id}`, respuesta);
  return response.data;
};
